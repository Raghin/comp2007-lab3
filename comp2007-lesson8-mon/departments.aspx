...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grdDepartments" runat="server" CssClass="table table-striped table-hover sort display"
        ...
        DataKeyNames="DepartmentID" AllowPaging="true" OnPageIndexChanging="grdDepartments_PageIndexChanging"
         PageSize="3" AllowSorting="true" OnSorting="grdDepartments_Sorting" OnRowDataBound="grdDepartments_RowDataBound">
        <Columns>        
